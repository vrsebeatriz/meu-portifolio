# 👩‍💻 Ana Beatriz - Portfolio

Um portfólio minimalista, moderno e de alta performance, desenvolvido para destacar minha trajetória como **Engenheira de Software Full-Stack** e pesquisadora em **Inteligência Artificial** e **Cibersegurança**.
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/vrsebeatriz/meu-portifolio.git
   ```
...
---
Desenvolvido com ☕ e ❤️ por [Ana Beatriz](https://www.linkedin.com/in/beatriz-araújo-381b2b249).
